...
import { GTM_CONTAINER_ID } from "@/lib/config/analytics";
import { consentBootstrapScript } from "@/lib/config/cookies";
...
export function TagManager() {
  ...
  return (
    <>
      <script
        id="wp-consent-default"
        dangerouslySetInnerHTML={{ __html: consentBootstrapScript() }}
      />
      <Script id="wp-gtm" strategy="afterInteractive">
